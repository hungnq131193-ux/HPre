package com.flowtube.app.integration.playback
...
import com.flowtube.app.player.LivePlaybackFacts
import com.flowtube.app.player.PlaybackStreamType
import com.flowtube.app.player.PlayerController
import com.flowtube.app.player.PlayerIntegrationProbe
import com.flowtube.app.player.StreamSelector
 ...
 *
 * Requirements:
 * 1. Test input: flowtubeSmokeQuery is required for live gate: absent/blank MUST fail("live gate query missing"), never skip/default.
...
class LivePlaybackGateTest {
    ...
    fun live_foreground_media3_playback_gate() = runBlocking {
        ...
        val queryArg = args.getString("flowtubeSmokeQuery")
        ...
        withTimeout(120_000L) {
            ...
            val app = ApplicationProvider.getApplicationContext<FlowTubeApplication>()
            ...
            for ((candidateIndex, videoItem) in candidatePool.withIndex()) {
                ...
                val selectionResult = StreamSelector.selectStream(streamInfo, com.flowtube.app.player.QualityPreference.Auto)
                ...
                var initialRenderSnapshot: com.flowtube.app.player.PlayerTestingSnapshot? = null

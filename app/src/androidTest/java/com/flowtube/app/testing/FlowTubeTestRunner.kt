...
class FlowTubeTestRunner : AndroidJUnitRunner() {
    companion object {
        @Volatile
    ...
    override fun onCreate(arguments: Bundle?) {
        ...
        if (isLive) {
            ...
            if (explicitClass.isNullOrBlank()) {
                ...
                val gateTestName = "com.flowtube.app.integration.playback.LivePlaybackGateTest"
    ...
    private fun isLiveRequested(args: Bundle?): Boolean {
        val arg = args?.getString("flowtubeLivePlayback")
            ?: System.getProperty("flowtubeLivePlayback")
    ...
    override fun newApplication(
        ...
        val arg = runnerArguments?.getString("flowtubeLivePlayback")
            ?: System.getProperty("flowtubeLivePlayback")
        if (arg?.toBoolean() == true || arg?.equals("true", ignoreCase = true) == true) {
            isLivePlaybackActive = true
        }
        ...
        val targetAppClass = if (isLivePlaybackActive) {
            ...
            TestFlowTubeApplication::class.java.name
        }

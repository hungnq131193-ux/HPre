...
import com.flowtube.app.model.AudioStream as DomainAudioStream
import com.flowtube.app.model.Channel as DomainChannel
import com.flowtube.app.model.ChannelDetails as DomainChannelDetails
import com.flowtube.app.model.Comment as DomainComment
import com.flowtube.app.model.CommentPage as DomainCommentPage
import com.flowtube.app.model.ContentKey
import com.flowtube.app.model.PlaylistDetails as DomainPlaylistDetails
import com.flowtube.app.model.PlaylistSummary as DomainPlaylistSummary
import com.flowtube.app.model.SearchFilter
import com.flowtube.app.model.SearchPage as DomainSearchPage
import com.flowtube.app.model.SearchResultItem
import com.flowtube.app.model.StreamInfo as DomainStreamInfo
import com.flowtube.app.model.SubtitleStream as DomainSubtitleStream
import com.flowtube.app.model.VideoDetails as DomainVideoDetails
import com.flowtube.app.model.VideoStream as DomainVideoStream
import com.flowtube.app.model.VideoSummary as DomainVideoSummary
...
/**
 * Pure mapping functions from NewPipeExtractor types to FlowTube domain models.
...
object NewPipeMappers {
    ...
    fun mapPageToPageToken(page: org.schabi.newpipe.extractor.Page?): com.flowtube.app.model.PageToken? {
        if (page == null) return null
        val url = page.url?.trim()
        if (!url.isNullOrBlank() && isValidHttpUrl(url)) {
            return com.flowtube.app.model.PageToken.Url(url)
        }
        val id = page.id?.trim()
        if (!id.isNullOrBlank()) {
            return com.flowtube.app.model.PageToken.Id(id)
        }
        return null
    }

    fun reconstituteNewPipePage(token: com.flowtube.app.model.PageToken?, baseUrl: String?): org.schabi.newpipe.extractor.Page? {
        if (token == null) return null
        return when (token) {
            is com.flowtube.app.model.PageToken.Url -> org.schabi.newpipe.extractor.Page(token.url)
            is com.flowtube.app.model.PageToken.Id -> org.schabi.newpipe.extractor.Page(baseUrl, token.id)
        }
    }

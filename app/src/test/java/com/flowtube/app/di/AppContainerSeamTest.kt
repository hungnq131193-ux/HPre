...
class AppContainerSeamTest {
    ...
    @Test
    fun flowTubeApplication_has_no_public_setter_or_container_replacement_method() {
        val appClass = FlowTubeApplication::class.java
        ...
        for (method in methods) {
            assertFalse(
                "FlowTubeApplication must not expose public container mutation method: ${method.name}",
        ...
        assertTrue("FlowTubeApplication must not declare public fields", declaredPublicFields.isEmpty())
    ...
    fun defaultAppContainer_shares_single_okHttpClient_between_mediaSourceFactory_and_controllers() {
        ...
        try {
            ...
            val controller = container.createPlayerController() as com.flowtube.app.player.SessionPlayerController
            ...
            val controllerMsfField = com.flowtube.app.player.SessionPlayerController::class.java.getDeclaredField("mediaSourceFactory")
    ...
    fun default_app_container_returns_one_global_session_controller() {
        var factoryCalls = 0
        val controller = object : com.flowtube.app.player.PlayerController {
            override val state = kotlinx.coroutines.flow.MutableStateFlow(com.flowtube.app.player.PlaybackState())
            ...
            override fun prepare(key: com.flowtube.app.model.ContentKey, streamInfo: com.flowtube.app.model.StreamInfo, startPositionMs: Long, playWhenReady: Boolean, initialQuality: com.flowtube.app.player.QualityOption?) = Unit
            ...
            override fun selectQuality(quality: com.flowtube.app.player.QualityOption) = Unit
            override fun release() = Unit
        }
        val provider = com.flowtube.app.player.AppScopedPlayerControllerProvider {
            factoryCalls++
            controller
        }
